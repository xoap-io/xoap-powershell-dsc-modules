<#
.SYNOPSIS​
This is a generated Microsoft-recommended security configuration based on Windows 10 Version 20H2 and Windows Server 2019 20H2 Security Baseline (EN)
​
.DESCRIPTION​
DSC configurations are PowerShell scripts that define a special type of function. To define a configuration, you use the PowerShell keyword Configuration. In this case, the name of the configuration is "XOAPMsSecBaselineW10Ent20H2UserRightsAssignment".​
...
Module Name    : XOAPMsSecBaselineW10Ent20H2W10Ent1903EnDSC
Resource Name  : XOAPMsSecBaselineW10Ent20H2UserRightsAssignment.schema.psm1
Author         : info@XOAP.io
​
.LINK​
...
#>
configuration XOAPMsSecBaselineW10Ent20H2UserRightsAssignment
{
