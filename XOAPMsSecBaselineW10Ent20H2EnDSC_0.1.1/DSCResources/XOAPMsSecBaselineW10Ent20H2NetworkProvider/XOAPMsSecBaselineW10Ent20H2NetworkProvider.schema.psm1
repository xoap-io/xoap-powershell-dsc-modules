...
​
.DESCRIPTION​
DSC configurations are PowerShell scripts that define a special type of function. To define a configuration, you use the PowerShell keyword Configuration. In this case, the name of the configuration is "XOAPMsSecBaselineW10Ent20H2NetworkProvider".​
...
Resource Name  : XOAPMsSecBaselineW10Ent20H2NetworkProvider.schema.psm1
Author         : info@XOAP.io
​
.LINK​
...
#>
configuration XOAPMsSecBaselineW10Ent20H2NetworkProvider
{
