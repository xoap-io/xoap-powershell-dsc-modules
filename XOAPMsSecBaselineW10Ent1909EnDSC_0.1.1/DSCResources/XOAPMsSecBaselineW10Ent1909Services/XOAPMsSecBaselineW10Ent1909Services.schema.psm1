...
​
.DESCRIPTION​
DSC configurations are PowerShell scripts that define a special type of function. To define a configuration, you use the PowerShell keyword Configuration. In this case, the name of the configuration is "XOAPMsSecBaselineW10Ent1909Services".​
...
Resource Name  : XOAPMsSecBaselineW10Ent1909Services.schema.psm1
Author         : info@XOAP.io
​
.LINK​
...
#>
configuration XOAPMsSecBaselineW10Ent1909Services
{
    ...
    Service 'Services_AppIDSvc'
    {
        Name = 'AppIDSvc'
        State = 'Running'
    }

    Service 'Services_XboxGipSvc'
    {
        Name = 'XboxGipSvc'
        State = 'Stopped'
    }

    Service 'Services_XblAuthManager'
    {
        Name = 'XblAuthManager'
        State = 'Stopped'
    }

    Service 'Services_XblGameSave'
    {
        Name = 'XblGameSave'
        State = 'Stopped'
    }

    Service 'Services_XboxNetApiSvc'
    {
        Name = 'XboxNetApiSvc'
        State = 'Stopped'
    }
