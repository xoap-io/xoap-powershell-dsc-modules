...
​
.DESCRIPTION​
DSC configurations are PowerShell scripts that define a special type of function. To define a configuration, you use the PowerShell keyword Configuration. In this case, the name of the configuration is "XOAPMsSecBaselineW10Ent1909WindowsDefender".​
...
Resource Name  : XOAPMsSecBaselineW10Ent1909WindowsDefender.schema.psm1
Author         : info@XOAP.io
​
.LINK​
...
#>
configuration XOAPMsSecBaselineW10Ent1909WindowsDefender
{
    ...
    WindowsDefender RealTimeScanAndSpyNetReporting
    {
