...
In this case, the name of the configuration is "XOAPVdiOptimizeW10Ent2004NetworkOptimization".​
...
Resource Name  : XOAPVdiOptimizeW10Ent2004NetworkOptimization.schema.psm1
Author         : info@XOAP.io
​
.LINK​
...
#>
configuration XOAPVdiOptimizeW10Ent2004NetworkOptimization
{
    param(
        [bool] $VdiOptimizeNetworkOptimization
    )
    ...
    if($VdiOptimizeNetworkOptimization){
