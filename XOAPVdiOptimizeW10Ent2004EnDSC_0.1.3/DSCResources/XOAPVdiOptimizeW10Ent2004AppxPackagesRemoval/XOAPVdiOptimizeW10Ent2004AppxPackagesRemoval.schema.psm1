...
In this case, the name of the configuration is "XOAPVdiOptimizeW10Ent2004AppxPackagesRemoval".​
...
Resource Name  : XOAPVdiOptimizeW10Ent2004AppxPackagesRemoval.schema.psm1
Author         : info@XOAP.io
​
.LINK​
...
#>
configuration XOAPVdiOptimizeW10Ent2004AppxPackagesRemoval
{
    param(
        [bool] $VdiOptimizeAppxPackagesRemoval
    )
    ...
    if($VdiOptimizeAppxPackagesRemoval){
