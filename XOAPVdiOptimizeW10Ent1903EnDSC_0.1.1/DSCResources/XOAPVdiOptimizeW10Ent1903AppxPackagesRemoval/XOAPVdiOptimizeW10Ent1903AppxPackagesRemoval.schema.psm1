...
In this case, the name of the configuration is "XOAPVdiOptimizeW10Ent1903AppxPackagesRemoval".​
...
Resource Name  : XOAPVdiOptimizeW10Ent1903AppxPackagesRemoval.schema.psm1
Author         : info@XOAP.io
​
.LINK​
...
#>
configuration XOAPVdiOptimizeW10Ent1903AppxPackagesRemoval
{
    ...
    Script Uninstall_MixedRealityPortalScript
    {
        GetScript = {
            Get-AppxPackage -Name Microsoft.MixedReality.Portal
        }
        SetScript = {
            $Item = "Microsoft.MixedReality.Portal"
            $Package = "*$Item*"
            Get-AppxPackage                    | Where-Object {$_.PackageFullName -like $Package} | Remove-AppxPackage -Erroraction Stop
            Get-AppxPackage -AllUsers          | Where-Object {$_.PackageFullName -like $Package} | Remove-AppxPackage -AllUsers -Erroraction Stop
            Get-AppxProvisionedPackage -Online | Where-Object {$_.PackageName -like $Package}     | Remove-AppxProvisionedPackage -Online -Erroraction Stop
    ...
    Script Uninstall_ScreenSketchScript
    {
        GetScript = {
            Get-AppxPackage -Name Microsoft.ScreenSketch
        }
        SetScript = {
            $Item = "Microsoft.ScreenSketch"
            $Package = "*$Item*"
            Get-AppxPackage                    | Where-Object {$_.PackageFullName -like $Package} | Remove-AppxPackage -Erroraction Stop
            Get-AppxPackage -AllUsers          | Where-Object {$_.PackageFullName -like $Package} | Remove-AppxPackage -AllUsers -Erroraction Stop
            Get-AppxProvisionedPackage -Online | Where-Object {$_.PackageName -like $Package}     | Remove-AppxProvisionedPackage -Online -Erroraction Stop
    ...
    Script Uninstall_WindowsSoundRecorderScript
    {
        GetScript = {
            Get-AppxPackage -Name Microsoft.WindowsSoundRecorder
        }
        SetScript = {
            $Item = "Microsoft.WindowsSoundRecorder"
            $Package = "*$Item*"
            Get-AppxPackage                    | Where-Object {$_.PackageFullName -like $Package} | Remove-AppxPackage -Erroraction Stop
            Get-AppxPackage -AllUsers          | Where-Object {$_.PackageFullName -like $Package} | Remove-AppxPackage -AllUsers -Erroraction Stop
            Get-AppxProvisionedPackage -Online | Where-Object {$_.PackageName -like $Package}     | Remove-AppxProvisionedPackage -Online -Erroraction Stop
    ...
    Script Uninstall_Microsoft3DviewerScript
    {
        GetScript = {
            Get-AppxPackage -Name Microsoft.Microsoft3Dviewer
        }
        SetScript = {
            $Item = "Microsoft.Microsoft3Dviewer"
            $Package = "*$Item*"
            Get-AppxPackage                    | Where-Object {$_.PackageFullName -like $Package} | Remove-AppxPackage -Erroraction Stop
            Get-AppxPackage -AllUsers          | Where-Object {$_.PackageFullName -like $Package} | Remove-AppxPackage -AllUsers -Erroraction Stop
            Get-AppxProvisionedPackage -Online | Where-Object {$_.PackageName -like $Package}     | Remove-AppxProvisionedPackage -Online -Erroraction Stop
