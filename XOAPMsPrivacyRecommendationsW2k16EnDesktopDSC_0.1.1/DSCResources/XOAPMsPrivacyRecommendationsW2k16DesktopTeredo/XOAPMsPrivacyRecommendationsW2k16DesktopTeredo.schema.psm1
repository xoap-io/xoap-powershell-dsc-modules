...
​
.DESCRIPTION​
DSC configurations are PowerShell scripts that define a special type of function. To define a configuration, you use the PowerShell keyword Configuration. In this case, the name of the configuration is "XOAPMsPrivacyRecommendationsW2k16DesktopTeredo".​
...
Resource Name  : XOAPMsPrivacyRecommendationsW2k16DesktopTeredo.schema.psm1
Author         : info@XOAP.io
​
.LINK​
https://docs.microsoft.com/en-us/windows/privacy/manage-connections-from-windows-operating-system-components-to-microsoft-services​
#>
configuration XOAPMsPrivacyRecommendationsW2k16DesktopTeredo
{
    Import-DSCResource -ModuleName 'PSDesiredStateConfiguration'

    Registry 'Teredo_State'
    {
