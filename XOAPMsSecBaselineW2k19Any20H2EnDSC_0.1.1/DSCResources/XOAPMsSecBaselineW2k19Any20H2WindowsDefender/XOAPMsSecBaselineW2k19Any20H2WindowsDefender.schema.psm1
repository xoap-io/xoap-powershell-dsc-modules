...
​
.DESCRIPTION​
DSC configurations are PowerShell scripts that define a special type of function. To define a configuration, you use the PowerShell keyword Configuration. In this case, the name of the configuration is "XOAPMsSecBaselineW2k19Any20H2WindowsDefender".​
...
Resource Name  : XOAPMsSecBaselineW2k19Any20H2WindowsDefender.schema.psm1
Author         : info@XOAP.io
​
.LINK​
...
#>
configuration XOAPMsSecBaselineW2k19Any20H2WindowsDefender
{
    ...
    Registry 'Registry(POL): HKLM:\Software\Policies\Microsoft\Windows Defender\PUAProtection'
         ...
         Registry 'Registry(POL): HKLM:\Software\Policies\Microsoft\Windows Defender\MpEngine\MpCloudBlockLevel'
         {
