...
In this case, the name of the configuration is "XOAPVdiOptimizeW10Ent1909DisableScheduleTasks".​
...
Resource Name  : XOAPVdiOptimizeW10Ent1909DisableScheduleTasks.schema.psm1
Author         : info@XOAP.io
​
.LINK​
...
#>
configuration XOAPVdiOptimizeW10Ent1909DisableScheduleTasks
{
    param(
        [bool] $VdiOptimizeDisableScheduleTask
    )
    ...
    if($VdiOptimizeDisableScheduleTask){
